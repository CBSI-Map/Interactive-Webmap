...
//ol.proj.get("EPSG:3857").setExtent([17802882.802707, -1057204.535936, 17810726.696974, -1052965.001824]);
var wms_layers = [];
...
var lyr_MselenHoniara_24 = new ol.layer.Vector({
                ...
                popuplayertitle: 'Mselen Honiara',
                interactive: true,
                title: '<img src="styles/legend/MselenHoniara_24.png" /> Mselen Honiara'
            });
...
lyr_SolomonPostOfficeBranchChoisuel_5.set('fieldLabels', {'NAME': 'inline label - visible with data', 'Access type': 'inline label - visible with data', 'Location': 'inline label - visible with data', 'Province': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
lyr_AelanDigital_6.set('fieldLabels', {'Name': 'inline label - visible with data', 'Status': 'inline label - visible with data', 'Location': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
lyr_EziPeiGizo_7.set('fieldLabels', {'Agent Name': 'inline label - visible with data', 'Location': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
lyr_EziPeiMalaita_8.set('fieldLabels', {'Name': 'inline label - visible with data', 'Access type': 'inline label - visible with data', 'Location': 'inline label - visible with data', 'Province': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
lyr_BredBankHoniara_9.set('fieldLabels', {'PROVINCES': 'inline label - visible with data', 'Bred    BRANCHES': 'inline label - visible with data', 'Type of Branche': 'inline label - visible with data', 'STREET ADDRESS & CITY': 'inline label - visible with data', 'LATITUDE': 'inline label - visible with data', 'LONGITUDE': 'inline label - visible with data', });
lyr_ANZGizo_10.set('fieldLabels', {'Merchant Name': 'inline label - visible with data', 'Location': 'inline label - visible with data', 'Physical Sreet Address - Location': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
lyr_ANZMunda_11.set('fieldLabels', {'Merchant Name': 'inline label - visible with data', 'Location': 'inline label - visible with data', 'Physical Sreet Address - Location': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
lyr_ANZHoniara_12.set('fieldLabels', {'ANZ   BRANCHES': 'inline label - visible with data', 'TYPE OF BRANCHE': 'inline label - visible with data', 'STREET ADDRESS & CITY': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
lyr_BankofSouthPacificGizo_13.set('fieldLabels', {'BSP BRANCHES': 'inline label - visible with data', 'STREET ADDRESS & CITY': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
lyr_BankofSouthPacificMunda_14.set('fieldLabels', {'BSP BRANCHES': 'inline label - visible with data', 'STREET ADDRESS & CITY': 'inline label - visible with data', 'field_3': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
lyr_BankofSouthPacificChoisuel_15.set('fieldLabels', {'NAME': 'inline label - visible with data', 'Access type': 'inline label - visible with data', 'Location': 'inline label - visible with data', 'Province': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
lyr_BankofSouthPacificMalaita_16.set('fieldLabels', {'Name': 'inline label - visible with data', 'Access type': 'inline label - visible with data', 'Location': 'inline label - visible with data', 'Province': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
lyr_BankofSouthPacificHoniara_17.set('fieldLabels', {'BSP BRANCHES': 'inline label - visible with data', 'STREET ADDRESS & CITY': 'inline label - visible with data', 'TYPE OF BRANCHE': 'inline label - visible with data', 'LATITUDE': 'inline label - visible with data', 'LONGITUDE': 'inline label - visible with data', });
lyr_MSelenChoisuel_18.set('fieldLabels', {'Name': 'inline label - visible with data', 'Access type': 'inline label - visible with data', 'Location': 'inline label - visible with data', 'Province': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
lyr_MSelenGizo_19.set('fieldLabels', {'Agent Type': 'inline label - visible with data', 'Agent Business Name': 'inline label - visible with data', 'Physical Address': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
lyr_MSelenRenbel_20.set('fieldLabels', {'NAME': 'inline label - visible with data', 'Access type': 'inline label - visible with data', 'Location': 'inline label - visible with data', 'Province': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
lyr_MSelenMalaita_21.set('fieldLabels', {'Name': 'inline label - visible with data', 'Access type': 'inline label - visible with data', 'Location': 'inline label - visible with data', 'Province': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
lyr_MSelenNoro_22.set('fieldLabels', {'Agent Type': 'inline label - visible with data', 'Agent Business Name': 'inline label - visible with data', 'Physical Address': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
lyr_MSelenMunda_23.set('fieldLabels', {'Agent Type': 'inline label - visible with data', 'Agent Business Name': 'inline label - visible with data', 'Physical Address': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
lyr_MselenHoniara_24.set('fieldLabels', {'Agent Type': 'inline label - visible with data', 'Agent Business Name': 'inline label - visible with data', 'Physical Address': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });
